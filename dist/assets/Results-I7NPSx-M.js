import{n as e,s as t,t as n}from"./jsx-runtime-2UHhqg_S.js";import{h as r}from"./index-CKNVMWg_.js";import{t as i}from"./supabaseClient-kQ1Q7cNq.js";import{t as a}from"./results-CZ04HdrC.js";var o=t(e(),1),s=n();function c(){let[e,t]=(0,o.useState)([]),[n,c]=(0,o.useState)([]),[l,u]=(0,o.useState)(``),d=JSON.parse(localStorage.getItem(`user`))?.organization_id;(0,o.useEffect)(()=>{let e=!0;async function n(){if(!d)return;let{data:n}=await i.from(`elections`).select(`id, title, organization_id, organizations(name)`).eq(`organization_id`,d),r=n?.map(e=>e.id)||[];if(!e)return;if(c(n||[]),r.length===0){t([]);return}let{data:a,error:o}=await i.from(`votes`).select(`
          *,
          students (
            program,
            year_level
