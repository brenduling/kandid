import{n as e,s as t,t as n}from"./jsx-runtime-2UHhqg_S.js";import{t as r}from"./pencil-C6vq5ytm.js";import{t as i}from"./plus-BfDl4B_M.js";import{t as a}from"./trash-2-Dml5w9_K.js";import{p as o,t as s}from"./index-Dm0rfV3K.js";import{t as c}from"./supabaseClient-BJR8ErGU.js";import{t as l}from"./PopupOverlay-SqBQe2Kt.js";import{n as u,r as d,t as f}from"./candidates-BKedCr1E.js";var p=t(e(),1),m=n();function h(){let e=s(),[t,n]=(0,p.useState)([]),[h,g]=(0,p.useState)([]),[_,v]=(0,p.useState)([]),[y,b]=(0,p.useState)([]),[x,S]=(0,p.useState)(!1),[C,w]=(0,p.useState)(null),[T,E]=(0,p.useState)({position_id:``,student_id:``,partylist_id:``,photo:``,bio:``,platform:``,credentials:``,campaign_materials:f()}),D=JSON.parse(localStorage.getItem(`user`))?.organization_id;(0,p.useEffect)(()=>{let e=!0;async function t(){if(!D)return;let{data:t}=await c.from(`elections`).select(`id`).eq(`organization_id`,D),r=t?.map(e=>e.id)||[];if(r.length===0){e&&(n([]),g([]),b([]));return}let{data:i}=await c.from(`positions`).select(`
          id,
          name,
          election_id,
          elections (
