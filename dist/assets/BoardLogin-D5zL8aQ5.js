import{n as e,s as t,t as n}from"./jsx-runtime-2UHhqg_S.js";import{O as r,a as i,c as a,o}from"./index-Bn7YUMeA.js";import{t as s}from"./supabaseClient-BJR8ErGU.js";import{t as c}from"./AuthLayout-BPSXqUvR.js";var l=t(e(),1),u=n();function d(){let[e,t]=(0,l.useState)(``),[n,d]=(0,l.useState)(``),[f,p]=(0,l.useState)(!1),m=r();(0,l.useEffect)(()=>{let e=o();e?.role===`electoral_board`&&m(i(e),{replace:!0})},[m]);async function h(t){t.preventDefault(),p(!0);let{data:r,error:i}=await s.from(`admin_users`).select(`
        id,
        email,
        password,
        full_name,
