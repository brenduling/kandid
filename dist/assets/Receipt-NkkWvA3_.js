import{n as e,s as t,t as n}from"./jsx-runtime-2UHhqg_S.js";import{t as r}from"./external-link-BZjfBQm6.js";import{t as i}from"./shield-check-CmyDMcn0.js";import{f as a}from"./index-Cdqor0u1.js";import{t as o}from"./supabaseClient-CKHYq6kB.js";import{i as s}from"./blockchain-D0QfJKGE.js";var c=t(e(),1),l=n();function u(){let[e,t]=(0,c.useState)([]),n=JSON.parse(localStorage.getItem(`user`));(0,c.useEffect)(()=>{let e=!0;async function r(){let{data:r,error:i}=await o.from(`votes`).select(`
          *,
          elections (
            title,
            organizations (
