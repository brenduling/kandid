import{n as e,s as t,t as n}from"./jsx-runtime-2UHhqg_S.js";import{a as r,c as i,o as a,w as o}from"./index-BvOT9YBc.js";import{t as s}from"./supabaseClient-dWtquuww.js";import{t as c}from"./AuthLayout-Cs46K2jC.js";var l=t(e(),1),u=n();function d(){let[e,t]=(0,l.useState)(``),[n,d]=(0,l.useState)(``),[f,p]=(0,l.useState)(!1),m=o();(0,l.useEffect)(()=>{let e=a();e?.role===`electoral_board`&&m(r(e),{replace:!0})},[m]);async function h(t){t.preventDefault(),p(!0);let{data:r,error:i}=await s.from(`admin_users`).select(`
        id,
        email,
        password,
        full_name,
